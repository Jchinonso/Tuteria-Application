...
ROOT_DIR = environ.Path(__file__) - 3  # (booking_service/config/settings/common.py - 3 = booking_service/)
...
SECRET_KEY = 'd%k4@m)&c&i&+yz4mk)j3db9)buxo$z^g9_hczjc=j3vi@l7g_'
...
ROOT_URLCONF = 'Tuteria.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'Tuteria.wsgi.application'
...
# Honeypot Settings
HONEYPOT_FIELD_NAME = 'guinnessnigeria_hp'
HONEYPOT_VALUE = 'guinnessnigeria'
